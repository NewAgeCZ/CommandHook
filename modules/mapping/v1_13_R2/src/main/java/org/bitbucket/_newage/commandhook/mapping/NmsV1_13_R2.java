...
public class NmsV1_13_R2 extends AMapping {
    ...
    public List<Entity> getEntitiesFromSelector(String selector, Block commandBlock) {
        ...
        try {
            List<? extends net.minecraft.server.v1_13_R2.Entity> nmsEntities = getNmsEntities(argumentParser, wrapper);
     ...
     */
    private List<? extends net.minecraft.server.v1_13_R2.Entity> getNmsEntities(ArgumentParserSelector argumentParser, CommandListenerWrapper wrapper) throws CommandSyntaxException {
        EntitySelector selector = argumentParser.s(false);
     ...
     * @return
     */
    private List<Entity> convertToBukkitEntity(List<? extends net.minecraft.server.v1_13_R2.Entity> entities) {
        return entities.stream()
                .map(net.minecraft.server.v1_13_R2.Entity::getBukkitEntity)
