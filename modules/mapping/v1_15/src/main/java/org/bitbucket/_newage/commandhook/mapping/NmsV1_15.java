...
import net.minecraft.server.v1_15_R1.ArgumentParserSelector;
...
public class NmsV1_15 extends AMapping {
    ...
    public List<Entity> getEntitiesFromSelector(String selector, Block commandBlock) {
        ...
        try {
            List<? extends net.minecraft.server.v1_15_R1.Entity> nmsEntities = getNmsEntities(argumentParser, wrapper);
     ...
     */
    private List<? extends net.minecraft.server.v1_15_R1.Entity> getNmsEntities(ArgumentParserSelector argumentParser, CommandListenerWrapper wrapper) throws CommandSyntaxException {
     ...
     * @return
     */
    private List<Entity> convertToBukkitEntity(List<? extends net.minecraft.server.v1_15_R1.Entity> entities) {
        return entities.stream()
                .map(net.minecraft.server.v1_15_R1.Entity::getBukkitEntity)
