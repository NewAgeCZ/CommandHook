...
import net.minecraft.server.v1_16_R1.ArgumentParserSelector;
import net.minecraft.server.v1_16_R1.EntitySelector;
import net.minecraft.server.v1_16_R1.BlockPosition;
import net.minecraft.server.v1_16_R1.CommandBlockListenerAbstract;
...
public class NmsV1_16_R1 extends AMapping {
    ...
    public List<Entity> getEntitiesFromSelector(String selector, Block commandBlock) {
        ...
        try {
            List<? extends net.minecraft.server.v1_16_R1.Entity> nmsEntities = getNmsEntities(argumentParser, wrapper);
     ...
     */
    private List<? extends net.minecraft.server.v1_16_R1.Entity> getNmsEntities(ArgumentParserSelector argumentParser, CommandListenerWrapper wrapper) throws CommandSyntaxException {
     ...
     * @return
     */
    private List<Entity> convertToBukkitEntity(List<? extends net.minecraft.server.v1_16_R1.Entity> entities) {
        return entities.stream()
                .map(net.minecraft.server.v1_16_R1.Entity::getBukkitEntity)
