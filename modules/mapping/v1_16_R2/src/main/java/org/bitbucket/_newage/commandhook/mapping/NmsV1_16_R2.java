...
import net.minecraft.server.v1_16_R2.ArgumentParserSelector;
import net.minecraft.server.v1_16_R2.EntitySelector;
import net.minecraft.server.v1_16_R2.BlockPosition;
import net.minecraft.server.v1_16_R2.CommandBlockListenerAbstract;
...
public class NmsV1_16_R2 extends AMapping {
    ...
    public List<Entity> getEntitiesFromSelector(String selector, Block commandBlock) {
        ...
        try {
            List<? extends net.minecraft.server.v1_16_R2.Entity> nmsEntities = getNmsEntities(argumentParser, wrapper);
     ...
     */
    private List<? extends net.minecraft.server.v1_16_R2.Entity> getNmsEntities(ArgumentParserSelector argumentParser, CommandListenerWrapper wrapper) throws CommandSyntaxException {
     ...
     * @return
     */
    private List<Entity> convertToBukkitEntity(List<? extends net.minecraft.server.v1_16_R2.Entity> entities) {
        return entities.stream()
                .map(net.minecraft.server.v1_16_R2.Entity::getBukkitEntity)
